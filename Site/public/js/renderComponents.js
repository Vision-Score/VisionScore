...
async function renderPopupJogador(container, data) {
    if (!container) return;

    document.querySelector(".loader").style.display = "flex";

    const melhoresCampeoes = await fetch("/jogadores/getMelhoresCampeoes/" + data.id)
        .then(function (resposta) {
            if (resposta.ok) {
                return resposta.json().then(function (melhoresCampeoes) {
        ...
        .catch(function (erro) {
            console.error(`Erro na requisição dos melhores campeões: ${erro.message}`);
            document.querySelector(".loader").style.display = "none";
        });
    ...
    const config = {
        ...
        stats: data.stats || [],
        badges: data.badges || [],
        powerPick: splashImages[data.powerPick],
    ...
    const renderMelhoresCampeoes = (campeoes) => {
        if (!campeoes || campeoes.length === 0) return '';
        return campeoes.map(c => `
            <div class="championThumbnail" style="background-image: url('${splashImages[c.nomeCampeao] || ''}')">
                <div class="championInfo">
                    <span class="championNome">${c.nomeCampeao}</span>
                    <div class="championStats">
                        <span>${c.winrate}% WR |</span>
                        <span>${c.kda} KDA</span>
                        <span>${c.jogos} JOGOS</span>
                    </div>
                </div>
            </div>
        `).join('');
    ...
    container.innerHTML = `
        <div class="popupJogadorContent">
            <div class="sideBar" style="background-image: linear-gradient(to top, #000000ee 40%, transparent 80%), url('${config.powerPick}'); background-size: cover; background-position: 70% 0%; box-shadow: inset 0px 0px 40px 4000px #00000050, inset 0px 0px 40px 40px #0F8B8B30">
                ...
                <div class="playerName">${config.name}
                <br>
                <span style="font-size: 20px; font-weight: 300; margin-top: 10px">Comfort</span>
                <br>
                <span style="font-size: 24px; font-weight: 600; margin-top: -10px">${data.powerPick}</span></div>
            ...
            <div class="mainContent">
                ...
                <div class="mainLower">
                    ...
                    <div class="mainLowerLower">
                        <span class="melhoresPicksTitle">Melhores picks</span>
                        <div class="championList">
                            ${renderMelhoresCampeoes(melhoresCampeoes)}
                        </div>
                    </div>
                </div>
            </div>
...
async function renderHighlightUltimoJogo(container, data) {
    if (!container) return;
    ...
    const config = {
        ...
        ouro: data.ouro || 0,
        kda: data.kda || "0.00",
        championUrl: await splashImages[data.nomeCampeao] || "../assets/cassiopeia_1.jpg"
    };
...
const splashImages = {
  ...
  "Akshan": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Akshan_0.jpg",
  "Alistar": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Alistar_0.jpg",
  "Ambessa": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ambessa_0.jpg",
  "Amumu": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Amumu_0.jpg",
  "Anivia": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Anivia_0.jpg",
  "Annie": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Annie_0.jpg",
  ...
  "Aurelion Sol": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/AurelionSol_0.jpg",
  "Aurora": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Aurora_0.jpg",
  "Azir": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Azir_0.jpg",
  "Bard": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Bard_0.jpg",
  "Bel'Veth": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Belveth_0.jpg",
  "Blitzcrank": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Blitzcrank_0.jpg",
  "Brand": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Brand_0.jpg",
  "Braum": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Braum_0.jpg",
  "Briar": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Briar_0.jpg",
  "Caitlyn": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Caitlyn_0.jpg",
  "Camille": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Camille_0.jpg",
  "Cassiopeia": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Cassiopeia_0.jpg",
  "Cho'Gath": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Chogath_0.jpg",
  "Corki": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Corki_0.jpg",
  ...
  "Dr. Mundo": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/DrMundo_0.jpg",
  "Ekko": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ekko_0.jpg",
  "Elise": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Elise_0.jpg",
  ...
  "Fiddlesticks": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Fiddlesticks_0.jpg",
  "Fiora": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Fiora_0.jpg",
  "Fizz": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Fizz_0.jpg",
  "Galio": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Galio_0.jpg",
  "Gangplank": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Gangplank_0.jpg",
  "Garen": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Garen_0.jpg",
  "Gnar": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Gnar_0.jpg",
  "Gragas": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Gragas_0.jpg",
  "Graves": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Graves_0.jpg",
  "Gwen": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Gwen_0.jpg",
  "Hecarim": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Hecarim_0.jpg",
  "Heimerdinger": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Heimerdinger_0.jpg",
  "Hwei": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Hwei_0.jpg",
  "Illaoi": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Illaoi_0.jpg",
  "Irelia": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Irelia_0.jpg",
  "Ivern": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ivern_0.jpg",
  "Janna": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Janna_0.jpg",
  "Jarvan IV": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/JarvanIV_0.jpg",
  "Jax": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Jax_0.jpg",
  "Jayce": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Jayce_0.jpg",
  "Jhin": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Jhin_0.jpg",
  "Jinx": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Jinx_0.jpg",
  "K'Sante": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/KSante_0.jpg",
  "Kai'Sa": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kaisa_0.jpg",
  "Kalista": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kalista_0.jpg",
  "Karma": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Karma_0.jpg",
  "Karthus": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Karthus_0.jpg",
  "Kassadin": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kassadin_0.jpg",
  ...
  "Kayn": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kayn_0.jpg",
  "Kennen": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kennen_0.jpg",
  "Kha'Zix": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Khazix_0.jpg",
  "Kindred": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kindred_0.jpg",
  "Kled": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Kled_0.jpg",
  "Kog'Maw": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/KogMaw_0.jpg",
  "LeBlanc": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Leblanc_0.jpg",
  ...
  "Lissandra": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Lissandra_0.jpg",
  "Lucian": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Lucian_0.jpg",
  "Lulu": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Lulu_0.jpg",
  "Lux": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Lux_0.jpg",
  "Malphite": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Malphite_0.jpg",
  "Malzahar": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Malzahar_0.jpg",
  "Maokai": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Maokai_0.jpg",
  "Master Yi": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/MasterYi_0.jpg",
  "Mel": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Mel_0.jpg",
  "Milio": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Milio_0.jpg",
  "Miss Fortune": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/MissFortune_0.jpg",
  "Mordekaiser": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Mordekaiser_0.jpg",
  "Morgana": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Morgana_0.jpg",
  "Naafiri": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Naafiri_0.jpg",
  "Nami": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nami_0.jpg",
  "Nasus": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nasus_0.jpg",
  "Nautilus": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nautilus_0.jpg",
  "Neeko": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Neeko_0.jpg",
  "Nidalee": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nidalee_0.jpg",
  "Nilah": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nilah_0.jpg",
  "Nocturne": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nocturne_0.jpg",
  "Nunu & Willump": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Nunu_0.jpg",
  "Olaf": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Olaf_0.jpg",
  ...
  "Poppy": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Poppy_0.jpg",
  "Pyke": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Pyke_0.jpg",
  "Qiyana": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Qiyana_0.jpg",
  "Quinn": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Quinn_0.jpg",
  "Rakan": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Rakan_0.jpg",
  "Rammus": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Rammus_0.jpg",
  "Rek'Sai": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/RekSai_0.jpg",
  "Rell": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Rell_0.jpg",
  "Renata Glasc": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Renata_0.jpg",
  "Renekton": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Renekton_0.jpg",
  ...
  "Rumble": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Rumble_0.jpg",
  "Ryze": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ryze_0.jpg",
  "Samira": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Samira_0.jpg",
  "Sejuani": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Sejuani_0.jpg",
  ...
  "Shaco": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Shaco_0.jpg",
  "Shen": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Shen_0.jpg",
  "Shyvana": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Shyvana_0.jpg",
  "Singed": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Singed_0.jpg",
  "Sion": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Sion_0.jpg",
  "Sivir": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Sivir_0.jpg",
  "Skarner": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Skarner_0.jpg",
  "Smolder": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Smolder_0.jpg",
  ...
  "Swain": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Swain_0.jpg",
  "Sylas": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Sylas_0.jpg",
  "Syndra": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Syndra_0.jpg",
  "Tahm Kench": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/TahmKench_0.jpg",
  "Taliyah": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Taliyah_0.jpg",
  "Talon": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Talon_0.jpg",
  "Taric": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Taric_0.jpg",
  ...
  "Tristana": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Tristana_0.jpg",
  "Trundle": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Trundle_0.jpg",
  "Tryndamere": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Tryndamere_0.jpg",
  "Twisted Fate": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/TwistedFate_0.jpg",
  "Twitch": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Twitch_0.jpg",
  "Udyr": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Udyr_0.jpg",
  "Urgot": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Urgot_0.jpg",
  "Varus": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Varus_0.jpg",
  "Vayne": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Vayne_0.jpg",
  "Veigar": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Veigar_0.jpg",
  "Vel'Koz": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Velkoz_0.jpg",
  "Vex": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Vex_0.jpg",
  "Vi": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Vi_0.jpg",
  "Viego": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Viego_0.jpg",
  "Viktor": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Viktor_0.jpg",
  "Vladimir": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Vladimir_0.jpg",
  "Volibear": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Volibear_0.jpg",
  "Warwick": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Warwick_0.jpg",
  "Wukong": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/MonkeyKing_0.jpg",
  "Xayah": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Xayah_0.jpg",
  "Xerath": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Xerath_0.jpg",
  "Xin Zhao": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/XinZhao_0.jpg",
  ...
  "Yorick": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Yorick_0.jpg",
  "Yunara": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Yunara_0.jpg",
  "Yuumi": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Yuumi_0.jpg",
  "Zaahen": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Zaahen_0.jpg",
  "Zac": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Zac_0.jpg",
  "Zed": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Zed_0.jpg",
  "Zeri": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Zeri_0.jpg",
  "Ziggs": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Ziggs_0.jpg",
  "Zilean": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Zilean_0.jpg",
  "Zoe": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Zoe_0.jpg",
  "Zyra": "https://ddragon.leagueoflegends.com/cdn/img/champion/splash/Zyra_0.jpg"
}